...
--changeset linlinenko:000_initial_schema

CREATE SCHEMA IF NOT EXISTS monkey_finance_app_dev;
CREATE EXTENSION IF NOT EXISTS citext SCHEMA monkey_finance_app_dev;
CREATE EXTENSION IF NOT EXISTS pgcrypto SCHEMA monkey_finance_app_dev;
SET search_path TO monkey_finance_app_dev;
...
CREATE TYPE monkey_finance_app_dev.category_type AS ENUM (
    'income',
    'expense'
);


-- ALTER TYPE monkey_finance_app_dev.category_type OWNER TO postgres;
...
CREATE TABLE monkey_finance_app_dev.budget_categories (
...
-- ALTER TABLE monkey_finance_app_dev.budget_categories OWNER TO postgres;

--
-- Name: budgets; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE monkey_finance_app_dev.budgets (
                                id uuid DEFAULT gen_random_uuid() NOT NULL,
...
-- ALTER TABLE monkey_finance_app_dev.budgets OWNER TO postgres;

--
-- Name: categories; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE monkey_finance_app_dev.categories (
                                   id uuid DEFAULT gen_random_uuid() NOT NULL,
                                   name monkey_finance_app_dev.citext NOT NULL UNIQUE,
                                   description text,
                                   type monkey_finance_app_dev.category_type NOT NULL,
                                   icon_url character varying(255),
...
-- ALTER TABLE monkey_finance_app_dev.categories OWNER TO postgres;

--
-- Name: finance_books; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE monkey_finance_app_dev.finance_books (
...
-- ALTER TABLE monkey_finance_app_dev.finance_books OWNER TO postgres;

--
-- Name: goals; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE monkey_finance_app_dev.goals (
                              id uuid DEFAULT gen_random_uuid() NOT NULL,
                              finance_book_id uuid NOT NULL,
                              name character varying(100) NOT NULL,
                              description text NOT NULL,
...
-- ALTER TABLE monkey_finance_app_dev.goals OWNER TO postgres;

--
-- Name: subcategories; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE monkey_finance_app_dev.subcategories (
                                      id uuid DEFAULT gen_random_uuid() NOT NULL,
                                      category_id uuid NOT NULL,
                                      name monkey_finance_app_dev.citext NOT NULL,
                                      description text,
                                      icon_url character varying(255),
                                      color character varying(7) DEFAULT '#000000'::character varying,
...
-- ALTER TABLE monkey_finance_app_dev.subcategories OWNER TO postgres;

--
-- Name: tags; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE monkey_finance_app_dev.tags (
                             name monkey_finance_app_dev.citext NOT NULL UNIQUE,
                             description text,
...
-- ALTER TABLE monkey_finance_app_dev.tags OWNER TO postgres;

--
-- Name: transactions; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE monkey_finance_app_dev.transactions (
                                     id uuid DEFAULT gen_random_uuid() NOT NULL,
                                     finance_book_id uuid NOT NULL,
...
-- ALTER TABLE monkey_finance_app_dev.transactions OWNER TO postgres;

--
-- Name: users; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE monkey_finance_app_dev.users (
                              username monkey_finance_app_dev.citext NOT NULL UNIQUE,
                              email monkey_finance_app_dev.citext NOT NULL UNIQUE,
...
-- ALTER TABLE monkey_finance_app_dev.users OWNER TO postgres;

--
-- Name: users_finance_books; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE monkey_finance_app_dev.users_finance_books (
...
-- ALTER TABLE monkey_finance_app_dev.users_finance_books OWNER TO postgres;

--
-- Name: budget_categories budget_categories_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY monkey_finance_app_dev.budget_categories
...
ALTER TABLE ONLY monkey_finance_app_dev.budgets
...
ALTER TABLE ONLY monkey_finance_app_dev.categories
...
ALTER TABLE ONLY monkey_finance_app_dev.finance_books
...
ALTER TABLE ONLY monkey_finance_app_dev.goals
...
ALTER TABLE ONLY monkey_finance_app_dev.subcategories
...
ALTER TABLE ONLY monkey_finance_app_dev.tags
...
ALTER TABLE ONLY monkey_finance_app_dev.transactions
...
ALTER TABLE ONLY monkey_finance_app_dev.users_finance_books
...
ALTER TABLE ONLY monkey_finance_app_dev.users
...
CREATE INDEX idx_transactions_finance_book_id
    ON monkey_finance_app_dev.transactions (finance_book_id);
...
CREATE INDEX idx_transactions_subcategory_id
    ON monkey_finance_app_dev.transactions (subcategory_id);
...
CREATE INDEX idx_budget_categories_budget_id
    ON monkey_finance_app_dev.budget_categories (budget_id);
...
ALTER TABLE ONLY monkey_finance_app_dev.budget_categories
    ADD CONSTRAINT budget_categories_fk_budget_id FOREIGN KEY (budget_id) REFERENCES monkey_finance_app_dev.budgets(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY monkey_finance_app_dev.budgets
    ADD CONSTRAINT budgets_fk_finance_book_id FOREIGN KEY (finance_book_id) REFERENCES monkey_finance_app_dev.finance_books(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY monkey_finance_app_dev.finance_books
    ADD CONSTRAINT finance_books_fk_creator_id FOREIGN KEY (creator_id) REFERENCES monkey_finance_app_dev.users(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY monkey_finance_app_dev.goals
    ADD CONSTRAINT goals_fk_finance_book_id FOREIGN KEY (finance_book_id) REFERENCES monkey_finance_app_dev.finance_books(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY monkey_finance_app_dev.subcategories
    ADD CONSTRAINT subcategories_fk_category_id FOREIGN KEY (category_id) REFERENCES monkey_finance_app_dev.categories(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY monkey_finance_app_dev.transactions
    ADD CONSTRAINT transactions_fk_finance_book_id FOREIGN KEY (finance_book_id) REFERENCES monkey_finance_app_dev.finance_books(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY monkey_finance_app_dev.transactions
    ADD CONSTRAINT transactions_fk_subcategory_id FOREIGN KEY (subcategory_id) REFERENCES monkey_finance_app_dev.subcategories(id) ON DELETE SET NULL;
...
ALTER TABLE ONLY monkey_finance_app_dev.users_finance_books
    ADD CONSTRAINT users_finance_books_fk_finance_book_id FOREIGN KEY (finance_book_id) REFERENCES monkey_finance_app_dev.finance_books(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY monkey_finance_app_dev.users_finance_books
    ADD CONSTRAINT users_finance_books_fk_user_id FOREIGN KEY (user_id) REFERENCES monkey_finance_app_dev.users(id) ON DELETE CASCADE;
